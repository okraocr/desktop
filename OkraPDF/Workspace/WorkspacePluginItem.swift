...
/// One row in the sidebar's Plugins section: a local parser, whether it can run
/// on this Mac right now, and the doctor badge that explains why you would pick
/// it.
///
...
struct WorkspacePluginItem: Identifiable, Equatable {
